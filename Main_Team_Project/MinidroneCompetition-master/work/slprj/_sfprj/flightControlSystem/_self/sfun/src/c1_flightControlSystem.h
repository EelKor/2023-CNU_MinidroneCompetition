...
typedef struct {
  ...
  void *c1_RuntimeVar;
  real_T c1_row_min;
  boolean_T c1_row_min_not_empty;
  real_T c1_row_max;
  boolean_T c1_row_max_not_empty;
  real_T c1_col_min;
  boolean_T c1_col_min_not_empty;
  real_T c1_col_max;
  boolean_T c1_col_max_not_empty;
  uint32_T c1_mlFcnLineNumber;
  void *c1_fcnDataPtrs[32];
  char_T *c1_dataNames[32];
  uint32_T c1_numFcnVars;
  uint32_T c1_ssIds[32];
  uint32_T c1_statuses[32];
  void *c1_outMexFcns[32];
  void *c1_inMexFcns[32];
