...
typedef struct c1_tag_GUM52DLBwcDkJRKLV2tSz c1_cell_5;
...
typedef struct c1_tag_4f3zucywOvoC0QgnMj36nF c1_cell_7;
...
typedef struct c1_tag_ge1UD3YqHcNerzgtJ4AjXF c1_cell_wrap_8;
...
typedef struct c1_tag_EX2wxrf7UhZ6FVbfRZyo7B c1_cell_9;
...
typedef struct c1_tag_wvqtwQNAx0JJ5IpvMHRcsG c1_cell_10;
...
typedef struct c1_tag_awFMsYYWj01uO3vmLPQJOE c1_cell_11;
...
typedef struct c1_tag_WYClaNMLzsYbJFiV2mng6F c1_cell_12;
...
typedef struct c1_tag_BoX4lGjW7CLGNTo2OWmlp c1_cell_13;
...
typedef struct c1_tag_6CsBRVljdCQyAxGT7eZM3E c1_cell_14;
...
typedef struct c1_tag_URxaCoPZWr69Oy7fwnFxl c1_cell_16;
...
typedef struct c1_tag_lgV6TtEjsHVlF5tYbjwFlF c1_s_lgV6TtEjsHVlF5tYbjwFlF;

#endif                                 /* typedef_c1_s_lgV6TtEjsHVlF5tYbjwFlF */
...
#ifndef typedef_c1_s_lFc4yenLpnRlydRiCMxaZD
#define typedef_c1_s_lFc4yenLpnRlydRiCMxaZD

typedef struct c1_tag_lFc4yenLpnRlydRiCMxaZD c1_s_lFc4yenLpnRlydRiCMxaZD;

#endif                                 /* typedef_c1_s_lFc4yenLpnRlydRiCMxaZD */
...
#ifndef struct_c1_tag_GUM52DLBwcDkJRKLV2tSz
#define struct_c1_tag_GUM52DLBwcDkJRKLV2tSz

struct c1_tag_GUM52DLBwcDkJRKLV2tSz
{
  char_T f1[6];
  char_T f2[7];
  char_T f3[5];
...
#endif                                 /* struct_c1_tag_GUM52DLBwcDkJRKLV2tSz */
...
struct c1_tag_lgV6TtEjsHVlF5tYbjwFlF
{
  char_T Value[36];
};

#endif                                 /* struct_c1_tag_lgV6TtEjsHVlF5tYbjwFlF */
...
#ifndef struct_c1_tag_lFc4yenLpnRlydRiCMxaZD
#define struct_c1_tag_lFc4yenLpnRlydRiCMxaZD

struct c1_tag_lFc4yenLpnRlydRiCMxaZD
{
  c1_cell_5 _data;
};

#endif                                 /* struct_c1_tag_lFc4yenLpnRlydRiCMxaZD */
...
typedef struct {
  ...
  void *c1_RuntimeVar;
  real_T c1_local_cond;
  boolean_T c1_local_cond_not_empty;
  uint8_T c1_local_array[4];
  boolean_T c1_local_array_not_empty;
  real_T c1_add_yaw;
  boolean_T c1_add_yaw_not_empty;
  real_T c1_add_yaw_first;
  boolean_T c1_add_yaw_first_not_empty;
  uint32_T c1_mlFcnLineNumber;
  void *c1_fcnDataPtrs[76];
  char_T *c1_dataNames[76];
  uint32_T c1_numFcnVars;
  uint32_T c1_ssIds[76];
  uint32_T c1_statuses[76];
  void *c1_outMexFcns[76];
  void *c1_inMexFcns[76];
  ...
  real_T *c1_yaw_out;
  real_T *c1_yaw_out2;
  int32_T (*c1_pts_erase_past_line)[4];
  int32_T (*c1_pts_local_area)[4];
  int32_T (*c1_pts_roi_circle)[6];
