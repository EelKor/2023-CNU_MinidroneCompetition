...
## Generated on : Thu Mar 16 13:46:34 2023
## Final product: ./flightControlSystemlib.lib
...
SRCS = $(START_DIR)/slprj/sim/flightControlSystem/flightControlSystem.c $(START_DIR)/slprj/sim/flightControlSystem/flightControlSystem_capi.c
...
OBJS = flightControlSystem.obj flightControlSystem_capi.obj
...
%.obj : $(START_DIR)/slprj/sim/flightControlSystem/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/flightControlSystem/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
flightControlSystem.obj : $(START_DIR)/slprj/sim/flightControlSystem/flightControlSystem.c
	$(CC) $(CFLAGS) -o "$@" "$<"


flightControlSystem_capi.obj : $(START_DIR)/slprj/sim/flightControlSystem/flightControlSystem_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
